  ...
  return (
    <section className="py-20 md:py-24 bg-[#fff] dark:bg-[#080101]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 w-full overflow-hidden">
            <h2 className="text-[43px] sm:text-5xl font-medium text-foreground mb-4 tracking-tighter text-wrap">Experience<span className="font-serif font-medium italic text-accent">Excellence</span></h2>
            <p className="desc text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="text-center border-border hover:shadow-lg transition-shadow bg-card">
              <CardContent className="p-6">
                ...
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" id="Chef-Hat-Heart--Streamline-Solar" className="h-16 w-16 fill-accent mx-auto mb-4">
            ...
            <Card className="text-center border-border hover:shadow-lg transition-shadow bg-card">
              <CardContent className="p-6">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14" id="Cocktail--Streamline-Core-Remix" className="h-14 w-14 fill-accent mx-auto mb-4">
            ...
            <Card className="text-center border-border hover:shadow-lg transition-shadow bg-card">
              <CardContent className="p-6">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" id="Brunch-Dining-Fill--Streamline-Outlined-Fill-Material" className="h-16 w-16 fill-accent mx-auto mb-4">
