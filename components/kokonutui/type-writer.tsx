...
const DEFAULT_SEQUENCES: TypewriterSequence[] = [
  { text: "Relax, Refresh", deleteAfter: true },
  { text: "And Repeat.", deleteAfter: false },
  // { text: "Refreshment,", deleteAfter: true },
];
  ...
  return (
    <div className="relative mx-auto w-full max-w-4xl py-2">
      <div className="relative z-10 flex flex-col items-center justify-center text-center">
        <motion.div
          animate={{ opacity: 1 }}
          className="flex items-center gap-1 font-mono text-black dark:text-white"
          initial={{ opacity: 0 }}
          transition={{ duration: 0.5 }}
        >
          <span className="inline-block min-h-[1.2em] min-w-[0.5em] text-primary textDisplay">
            {displayText}
          </span>
          <motion.span
            animate={{
