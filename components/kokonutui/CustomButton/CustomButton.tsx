...
export default function SlideTextButton({
  ...
  const variantStyles =
    variant === "ghost"
      ? "border border-black/10 text-black hover:bg-accent hover:text-accent-foreground dark:border-white/10 dark:text-white"
      : variant === "primary"
        ? "bg-accent text-foreground hover:bg-accent/90 dark:text-foreground dark:hover:bg-accent/80"
