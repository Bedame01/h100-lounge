...
import { ArrowRight, Repeat2, Archive } from "lucide-react";
...
export default function CardFlip({
  ...
  text = "Start today",
  href = "#",
  icon = <Drinks className="h-16 w-16 fill-orange-500" />,
}: CardFlipProps) {
  const [isFlipped, setIsFlipped] = useState(false);

  return (
    <div
      className="group relative h-[350px] lg:h-[400px] w-full [perspective:2000px]"
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="absolute right-0 bottom-0 left-0 p-5 lg:pb-8">
            <div className="flex items-center justify-between gap-3">
              <div className="space-y-1.5">
                <h3 className="font-semibold text-lg uppercase text-zinc-900 leading-snug tracking-tighter transition-all duration-500 ease-out-expo group-hover:translate-y-[-4px] dark:text-white">
                  {title}
                </h3>
