      ...
      {categories.map((category: Category) => {
        ...
        return (
          <section key={category.id} className="py-6 px-2.5 md:px-10! lg:px-18! last:border-b-0">
            <div className="container rounded-md border border-border mx-auto px-4 sm:px-8 lg:px-10 py-8 sm:py-10 lg:py-14">
      ...
      <div className="pt-16">
        <section className="pt-16 md:pt-26 pb-10 md:pb-14! mb-5 border-b border-border">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="allergiesInform flex items-center justify-center gap-2 w-full max-w-md mx-auto mt-7 bg-foreground/10 rounded-2xl py-3 px-4 border-border">
              ...
              <p className="text-sm text-muted-foreground font-semibold">Please inform staff of any allergies</p>
            </div>
          </div>
        </section>
